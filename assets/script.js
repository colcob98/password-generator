...
function passwordOptions () {
    var determineLength = Number(prompt('How many characters would you like your password to contain?\n(Length must be at least 8 characters but no more than 128 characters'));
    ...
    var selectedOptions = {
        ...
        lowercaseLetters: includeLowercaseLetters,
        uppercaseLetters: includeUppercaseLetters,
...
function randomize(arr) {Math.floor(Math.random() + arr.length)};

function generatePassword () {
    var selectedOptions = passwordOptions();
